...
public class UsuarioVO {
    ...
    public UsuarioVO(String identificacionUsu, String nombreUsu, String emailUsu, String direccionUsu, String telefonoUsu, String claveUsu, String rolId) {
    ...
    public UsuarioVO(String emailUsu,String claveUsu ) {
        this.emailUsu = emailUsu;
        this.claveUsu = claveUsu;
    ...
    public UsuarioVO(String identificacionUsu, String nombreUsu, String emailUsu, String rolId) {
    }
